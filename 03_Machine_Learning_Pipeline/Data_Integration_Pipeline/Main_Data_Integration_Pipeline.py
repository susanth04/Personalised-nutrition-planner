...
class MicrobiomeDataProcessor:
    ...
    def load_specific_files(self):
        ...
        try:
            ...
            self.genera_counts = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\genera.counts (2).tsv", sep="\t")
            print(f"Loaded genera_counts: {self.genera_counts.shape}")
            
            self.metadata = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\metadata (1).tsv", sep="\t")
            print(f"Loaded metadata: {self.metadata.shape}")
            
            self.mtb = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\mtb.tsv", sep="\t")
            print(f"Loaded mtb (metabolites): {self.mtb.shape}")
            
            self.species_counts = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\species.counts (2).tsv", sep="\t")
            print(f"Loaded species_counts: {self.species_counts.shape}")
            
            self.species = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\species (4).tsv", sep="\t")
            print(f"Loaded species: {self.species.shape}")
            
            self.genera = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\genera (1).tsv", sep="\t")
            print(f"Loaded genera: {self.genera.shape}")
            
            self.lda = pd.read_csv(r"C:\RESEARCH-PROJECT\IHMP\data_integration_pipeline\LDA_bacteria.csv", sep="\t")
